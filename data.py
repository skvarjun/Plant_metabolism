...
class MasterData:
    def __init__(self):
        self.scaled_data = pd.read_csv('/home/skvarjun/CMEE/Plant_metabolism_nanoplastic/scaled.csv')
        self.master_data = pd.read_csv('/home/skvarjun/CMEE/Plant_metabolism_nanoplastic/master_data.csv')
